...
<body>
    <div id="app">
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        ...
                        @guest
                            @if (Route::has('login'))
                                <a href="{{ route('login') }}" class="text-black hover:bg-[#fff] hover:text-white px-3 py-2 rounded-md text-sm font-medium">Login</a>
                            @endif

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="text-black hover:bg-[#fff] hover:text-white px-3 py-2 rounded-md text-sm font-medium">Register</a>
                            @endif
                        @else
        ...
        <main class='bg-[#eeece7]'>
            @yield('content')
        </main>
        <footer class="bg-[#be9b75] text-white">
